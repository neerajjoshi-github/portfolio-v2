...
const ProjectsSection = () => {
  return (
    <section id="projects" className="min-h-[calc(100vh-64px)] w-full py-10">
      <h2 className="relative w-fit text-5xl md:text-8xl mb-6 font-black uppercase font-sectionHeading">
        Projects
        <Image
      ...
      <div className="w-full grid grid-cols-2 gap-6 mt-6">
        <div className="bg-slate-950 rounded-md flex flex-col gap-4">
          ...
          <div className="border-t-2 border-b-2 border-white bg-black/50 rounded-t-3xl backdrop-blur-md -mt-16 p-4 flex flex-col gap-4">
            <h3 className="text-3xl">Reddit Clone</h3>
        ...
        <div className="bg-slate-950 rounded-md flex flex-col gap-4">
          ...
          <div className="border-t-2 border-b-2 border-white bg-black/50 rounded-t-3xl backdrop-blur-md -mt-16 p-4 flex flex-col gap-4">
            <h3 className="text-3xl">Novus BloodBank</h3>
            <p className="text-zinc-300">
